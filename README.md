[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_it/raw/main/dist/nv_it_v5.55.0.pyz)
...
Download the latest release [nv_it_v5.55.0.pyz](https://github.com/peter88213/nv_it/raw/main/dist/nv_it_v5.55.0.pyz) (233 KB)

- Launch *nv_it_v5.55.0.pyz* by double-clicking (Windows desktop),
- or execute `python nv_it_v5.55.0.pyz` (Windows), resp. `python3 nv_it_v5.55.0.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_it_v5.55.0.zip](https://github.com/peter88213/nv_it/raw/main/dist/nv_it_v5.55.0.zip) (234 KB)

- Extract the *nv_it_v5.55.0* folder from the downloaded zipfile "nv_it_v5.55.0.zip".

[novelibre Pagina principale](https://github.com/peter88213/novelibre) > [Pagine in italiano](../../) > [Aiuto online](../) > nv_editor
...
With **Sezione > Dividi** or `Ctrl`-`Alt`-`S`, you can
...
With **Sezione > Nuovo** or `Ctrl`-`Alt`-`N`, you can create a section.

[novelibre Pagina principale](https://github.com/peter88213/novelibre) > [Pagine italiane](../) > [Aiuto in linea](./) > Parte menu
...
With **Parte > Aggiungi**, you can add a part to the tree.
...
With **Parte > Esporta descrizione parte per modifica**, you can create a
...
With **Parte > Esporta tabella parte**, you can create a spreadsheet that

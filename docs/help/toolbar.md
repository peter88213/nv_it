[novelibre Pagina principale](https://github.com/peter88213/novelibre) > [Pagine italiane](../) > [Aiuto in linea](./) > The toolbar
...
![Aggiorna dal manoscritto](images/updateFromManuscript.png) Import the
...
![Aggiungi elemento figlio](images/addChild.png) Add child element. Same as
`Ctrl`-`Alt`-`N`.

![Aggiungi elemento padre](images/addParent.png) Add element on the parent's level.
Same as `Ctrl`-`Alt`-`Maiusc`-`N`.

![Cancella](images/remove.png) Delete selected elements. Same as `Canc`.
